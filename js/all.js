...
(function (w) {
  ...
  $(w).resize(function () {
    ...
    sh = document.body.clientHeight; //updateAds();
  }); //Navigation toggle
...
(function (window, undefined) {
  ...
  */
  ...
  jQuery.support = function (support) {
    ...
    input.type = 'checkbox'; // Check the default checkbox/radio value ("" on old WebKit; "on" elsewhere)

    support.checkOn = input.value === ''; // Must access the parent to make an option select properly
    // Support: IE9, IE10

    support.optSelected = opt.selected; // jQuery.support.boxModel DEPRECATED in 1.8 since we don't support Quirks Mode

    support.boxModel = document.compatMode === 'CSS1Compat'; // Will be defined later
    ...
    fragment.appendChild(input); // old WebKit doesn't clone checked state correctly in fragments

    support.checkClone = fragment.cloneNode(true).cloneNode(true).lastChild.checked; // Support: Firefox 17+
  ...
  jQuery.fn.extend({
    data: function (key, value) {
      ...
      return jQuery.access(this, function (value) {
        var data,
            camelKey = jQuery.camelCase(key); // Get the Data...
        ...
        this.each(function () {
          ...
          data_user.set(this, camelKey, value); // *... In the case of properties that might ACTUALLY
  ...
  */
  ...
  (function (window, undefined) {
    ...
    setDocument = Sizzle.setDocument = function (node) {
      ...
      support.getByName = assert(function (div) {
        // Inject content
        div.id = expando + 0; // Support: Windows 8 Native Apps
        ...
        doc.getElementsByName(expando + 0).length; // Cleanup
    ...
    Sizzle.uniqueSort = function (results) {
      ...
      hasDuplicate = !support.detectDuplicates; // Compensate for sort limitations
    ...
    Expr.setFilters = new setFilters(); // Check sort stability

    support.sortStable = expando.split('').sort(sortOrder).join('') === expando; // Initialize with the default document

    setDocument(); // Always assume the presence of duplicates if sort doesn't
    // pass them to our comparison function (as in Google Chrome).

    [0, 0].sort(sortOrder);
    support.detectDuplicates = hasDuplicate; // Override sizzle attribute retrieval
  ...
  jQuery.fn.extend({
    ...
    replaceWith: function (value) {
      var isFunction = jQuery.isFunction(value); // Make sure that the elements are removed from the DOM before they are inserted
    ...
    if (jQuery.support.cors || xhrSupported && !options.crossDomain) {
      return {
        send: function (headers, complete) {
          ...
          callback = xhrCallbacks[id = xhrId++] = callback('abort'); // Do send the request
...
//# sourceMappingURL=jquery-2.0.0b2.js.map
